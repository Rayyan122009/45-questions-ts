...
var countArray = [];
for (var _i = 0, mySchoolFriendsIWantToInvite_1 = mySchoolFriendsIWantToInvite; _i < mySchoolFriendsIWantToInvite_1.length; _i++) {
    var invitedFriend = mySchoolFriendsIWantToInvite_1[_i];
...
//     tracks?: number;
// };
// function AlbumDetails  (artists: string, albums: string, tracks: number): artistswAlbums  {
//     const albumDetails: artistswAlbums = { artists, albums, };
//         if (tracks != undefined)
// {
...
// const cigeretteAfterTextAlbumDetails = AlbumDetails("", "Apocalypse",21 );
...
var magiciansCopy = ['Jhon', 'AMIR', 'The Founders',];
function makeGreat() {
    for (var magicians = 0; magicians < magiciansCopy.length; magicians++) {
...
var makeSandwich = function (sandwich) {
    return console.log("Items Customer want in sandwich are ".concat(sandwich, " "));
};
